...
public class p1w1d2 extends AppCompatActivity {
    ...
    private void setUpModels(){
        String[] modelCW = getResources().getStringArray(R.array.cw2);
        String[] modelPR= getResources().getStringArray(R.array.pr2);
        String[] modelPO = getResources().getStringArray(R.array.po2);
        String[] modelSE = getResources().getStringArray(R.array.se2);
